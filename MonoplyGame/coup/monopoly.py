import random
#Import the random module for generating random numbers for dice.

# Class representing a Property and setup for the board.
class Property:
...
class Monopoly:
    ...
    def init_board(self): #this is the board for the game
        return [
...
if __name__ == "__main__": # __name__ is equal to __main__ meaning that the code is being run directly
    print("Welcome to Monopoly! Win by bankrupting the other players!\n")
    game = Monopoly()
    game.play_game()
